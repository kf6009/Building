...
\end{lcom}%
\@x{ {\CONSTANT}}%
\@x{\@s{16.4} People ,\,\@s{18.40}}%
\@y{\@s{0}%
 we\mbox{'}re dealing with people here
}%
\@xx{}%
\@x{\@s{69.91}}%
\@y{\@s{0}%
...
\@x{\@s{16.4} permission ,\,}%
\@y{\@s{0}%
 Function giving permissions
}%
\@xx{}%
\@x{\@s{16.4} location\@s{19.27}}%
\@y{\@s{0}%
 Function giving location
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ outside \.{\defeq} {\CHOOSE} x \.{:} x \.{\notin} Buildings}%
\@y{\@s{0}%
 outside is not in a Building
}%
\@xx{}%
\begin{lcom}{7.5}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 To check the above, \ensuremath{TLC} throws an error ``\ensuremath{TLC}
 attempted to evaluate an unbounded \ensuremath{{\CHOOSE}}.''
 The solution to this is to use the ``Additional Spec
 Options''\ensuremath{\.{\rightarrow}} ``definition override'' option
...
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{9.74} register \.{\subseteq} People\@s{12.29}}%
\@y{\@s{0}%
 Everyone on the register is a person
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} permission \.{\in} [ register
 \.{\rightarrow} {\SUBSET} Buildings ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} location \.{\in} [ register \.{\rightarrow}
 Buildings \.{\cup} \{ outside \} ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} outside \.{\notin} Buildings}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{16.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{12.29} \.{\land} register\@s{14.64} \.{=} \{ \}\@s{12.29}}%
\@y{\@s{0}%
 Initially no-one is registered
}%
\@xx{}%
 \@x{\@s{12.29} \.{\land} permission \.{=} [ x \.{\in} \{ \} \.{\mapsto} \{ \}
 ]\@s{20.5}}%
\@y{\@s{25.0}%
 no-one has permissions
}%
\@xx{}%
 \@x{\@s{12.29} \.{\land} location\@s{13.16} \.{=} [ x \.{\in} \{ \}
 \.{\mapsto} outside ]\@s{4.1}}%
\@y{\@s{25.0}%
 no-one is anywhere
}%
\@xx{}%
...
\@x{ Register ( p ) \.{\defeq}}%
 ...
 register\@s{28.7}}%
\@y{\@s{0}%
 \ensuremath{p} is a person and not registered
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} register \.{'} \.{=} register \.{\cup} \{ p
 \}\@s{17.68}}%
\@y{\@s{0}%
 add \ensuremath{p} to register
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} permission \.{'} \.{=} [ x \.{\in} {\DOMAIN}
 permission \.{\cup} \{ p \} \.{\mapsto}}%
\@x{\@s{93.83} {\IF} x \.{\in} {\DOMAIN} permission}%
\@x{\@s{93.83} \.{\THEN} permission [ x ]}%
\@x{\@s{93.83} \.{\ELSE} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} location \.{'}\@s{13.16} \.{=} [ x \.{\in} {\DOMAIN}
 location \.{\cup} \{ p \} \.{\mapsto}}%
\@x{\@s{93.83} {\IF} x \.{\in} {\DOMAIN} location}%
\@x{\@s{93.83} \.{\THEN} location [ x ]}%
\@x{\@s{93.83} \.{\ELSE} outside ]}%
\@pvspace{8.0pt}%
\@x{ DeRegister ( p ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Unregister a person
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} p \.{\in} register\@s{163.92}}%
\@y{\@s{0}%
 person is registered
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} location [ p ] \.{=} outside\@s{125.47}}%
\@y{\@s{0}%
 person is outside
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} register \.{'} \.{=} register \.{\,\backslash\,} \{ p
 \}}%
 \@x{\@s{16.4} \.{\land} location \.{'}\@s{13.16} \.{=} [ x \.{\in} {\DOMAIN}
 location \.{\,\backslash\,} \{ p \} \.{\mapsto}\@s{17.26}}%
\@y{\@s{0}%
 remove \ensuremath{p} from domain of location
}%
\@xx{}%
\@x{\@s{93.83} location [ x ] ]\@s{101.02}}%
\@y{\@s{0}%
 preserve other locations
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} permission \.{'} \.{=} [ x \.{\in} {\DOMAIN}
 permission \.{\,\backslash\,} \{ p \} \.{\mapsto}\@s{4.10}}%
\@y{\@s{0}%
 remove \ensuremath{p} from domain of permissions
}%
\@xx{}%
\@x{\@s{93.83} permission [ x ] ]\@s{87.86}}%
\@y{\@s{0}%
 preserve other permissions
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ AddPermission ( p ,\, b ) \.{\defeq}}%
\@y{\@s{0}%
 add permission for person \ensuremath{p} for building \ensuremath{b
}}%
\@xx{}%
\@x{\@s{16.4} \.{\land} p \.{\in} register\@s{70.17}}%
\@y{\@s{0}%
 \ensuremath{p} is registered
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} p \.{\in} {\DOMAIN} permission\@s{16.40}}%
\@y{\@s{0}%
 \ensuremath{p} has permissions
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} permission \.{'} \.{=} [ permission {\EXCEPT} {\bang}
 [ p ] \.{=} @ \.{\cup} \{ b \} ]}%
\@y{\@s{0}%
 add \ensuremath{b} to permissions for \ensuremath{p
}}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} location}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} register}%
\@pvspace{8.0pt}%
\@x{ RevokePermission ( p ,\, b ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} p \.{\in} register}%
\@x{\@s{16.4} \.{\land} p \.{\in} {\DOMAIN} permission}%
 \@x{\@s{16.4} \.{\land} permission \.{'} \.{=} [ permission {\EXCEPT} {\bang}
 [ p ] \.{=} @ \.{\,\backslash\,} \{ b \} ]}%
\@y{\@s{0}%
 remove \ensuremath{b} from permissions for \ensuremath{p
}}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} location}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} register}%
\@pvspace{8.0pt}%
\@x{ Enter ( p ,\, b ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} p \.{\in} register\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{p} is registered
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} b\@s{0.51} \.{\in} permission [ p ]\@s{8.2}}%
\@y{\@s{0}%
 \ensuremath{p} has permission to enter \ensuremath{b
}}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} location \.{'} \.{=} [ location {\EXCEPT} {\bang} [ p
 ] \.{=} b ]\@s{4.1}}%
\@y{\@s{0}%
 update \ensuremath{p}\mbox{'}s location
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} register\@s{14.64}}%
\@y{\@s{0}%
 does not change who is registered
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} permission}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Leave ( p ,\, b ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} p \.{\in} register\@s{24.56}}%
\@y{\@s{0}%
 \ensuremath{p} is registered
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} location [ p ] \.{=} b\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{p} is in the building
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} location \.{'} \.{=} [ location {\EXCEPT} {\bang} [ p
 ] \.{=} outside ]}%
\@y{\@s{0}%
 update \ensuremath{p}\mbox{'}s location now outside
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} register\@s{18.74}}%
\@y{\@s{0}%
 don\mbox{'}t change register
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} permission\@s{4.10}}%
\@y{\@s{0}%
 don\mbox{'}t change permissions
}%
\@xx{}%
\@pvspace{24.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \E\, p \.{\in} People ,\, b \.{\in} Buildings \.{:}}%
\@y{\@s{0}%
 There is a person and a building that
}%
\@xx{}%
\@x{\@s{27.72} \.{\lor} Register ( p )\@s{79.98}}%
\@y{\@s{0}%
 the person can be registered
}%
\@xx{}%
\@x{\@s{27.72} \.{\lor} DeRegister ( p )\@s{67.83}}%
\@y{\@s{0}%
 the person can be un-registered
}%
\@xx{}%
\@x{\@s{27.72} \.{\lor} AddPermission ( p ,\, b )\@s{37.74}}%
\@y{\@s{0}%
 the person can have a permission
}%
\@xx{}%
\@x{\@s{27.72} \.{\lor} RevokePermission ( p ,\, b )\@s{24.59}}%
\@y{\@s{0}%
 the person can have permission
}%
\@xx{}%
\@x{\@s{27.72} \.{\lor} Enter ( p ,\, b )\@s{69.7}}%
\@y{\@s{0}%
 the person can enter the building
}%
\@xx{}%
\@x{\@s{27.72} \.{\lor} Leave ( p ,\, b )\@s{57.43}}%
\@y{\@s{0}%
 the person can leave the building
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 10 01:46:58 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Feb} 09 21:24:32 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Oct} 02 10:31:48 \ensuremath{BST} 2019 by \ensuremath{alun
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Sep} 10 12:27:57 \ensuremath{BST} 2019 by \ensuremath{cgam1
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Sep} 24
 11:53:39 \ensuremath{BST} 2018 by \ensuremath{cgam1
}%
\end{cpar}%
\end{lcom}%
\end{document}
